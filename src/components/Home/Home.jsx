        ...
        <div id="#" className='w-screen md:pt-[6rem] md:pb-[2rem] pb-[4rem] pt-[2rem] py-0 dark:bg-[#23304c]'>
            <div className='Home_container '>
                <div className="Home_content flex flex-wrap justify-center items-center py-16 space-x-32">
                    ...
                    <div className='home_img w-[300px] h-[300px] bg-rose-400 bg-cover rounded-full bg-[url("C:\Users\91931\OneDrive\Desktop\Portfolio\src\resources\MyPhoto.jpeg")] '> 
                    </div>
                    ...
                    <div className="home_data sm:col-auto col-span-2">
                        ...
                        <Link to="/Contact" >
                            <button className='flex justify-center items-center bg-blue-900 hover:bg-blue-700 text-white p-4 rounded-md font-medium'>
                                Contact Me
